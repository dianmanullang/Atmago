...
WebUI.click(findTestObject('AT_Buat Laporan(LayananPublik)/a_Posting sebagai Admin Komunitas'))
...
WebUI.submit(findTestObject('AT_Buat Laporan(LayananPublik)/button_Kirim'))
