...
//if (WebUI.verifyElementVisible(findTestObject('AT_LoginByEmail/input_Email_email'),GlobalVariable.username) {
	
//	WebUI.setText(findTestObject('AT_LoginByEmail/input_Email_email'), GlobalVariable.username)
//}

//if(WebUI.verifyElementPresent(findTestObject('AT_LoginByEmail/input_Email_email'),5, FailureHandling.CONTINUE_ON_FAILURE ))
