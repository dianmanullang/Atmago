...
WebUI.click(findTestObject('AT_Buat Laporan(Bencana)/a_Posting sebagai Admin Komunitas'))
...
WebUI.uploadFile(findTestObject('AT_Buat Laporan(Bencana)/div_Masukkan gambar'), file)
