...
WebUI.selectOptionByLabel(findTestObject('AT_Buat Laporan(LayananPublik)/select_JalanAngkutanPerusakan'), infrastruktur, 
    false)

WebUI.setText(findTestObject('AT_Buat Laporan(LayananPublik)/input__svelte-17qb5ew'), provinsi)

WebUI.sendKeys(findTestObject('AT_Buat Laporan(LayananPublik)/input__svelte-17qb5ew'), Keys.chord(Keys.DOWN, Keys.ENTER))

WebUI.setText(findTestObject('AT_Buat Laporan(LayananPublik)/input__Kabupaten'), kabupaten)

WebUI.sendKeys(findTestObject('AT_Buat Laporan(LayananPublik)/input__Kabupaten'), Keys.chord(Keys.DOWN, Keys.ENTER))

WebUI.setText(findTestObject('AT_Buat Laporan(LayananPublik)/input__Kecamatan'), kecamatan)

WebUI.sendKeys(findTestObject('AT_Buat Laporan(LayananPublik)/input__Kecamatan'), Keys.chord(Keys.DOWN, Keys.ENTER))

WebUI.setText(findTestObject('AT_Buat Laporan(LayananPublik)/textarea__post_text'), text)

WebUI.uploadFile(findTestObject('AT_Buat Laporan(LayananPublik)/div_Masukkan gambar'), upload)
