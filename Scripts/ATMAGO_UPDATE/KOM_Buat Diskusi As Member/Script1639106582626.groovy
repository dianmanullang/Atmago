...
WebUI.navigateToUrl('https://komunitas.atmago.com/communities/followed')

WebUI.click(findTestObject('KOM_Buat Diskusi/List_komunitas'))

WebUI.click(findTestObject('KOM_Buat Diskusi/Buat Diskusi as Member'))

WebUI.setText(findTestObject('KOM_Buat Diskusi/Judul'), judul)
