...
//WebUI.navigateToUrl('https://www.atmago.com/login/email')
...
WebUI.navigateToUrl('https://komunitas.atmago.com/new/post')

WebUI.click(findTestObject('AT_Buat Berita/a_Berita WargaBagikan kabar berita terkini'))

//WebUI.click(findTestObject('AT_Buat Berita/Pilih Berita Warga'))
WebUI.setText(findTestObject('AT_Buat Berita/Judul'), Judul)

WebUI.setText(findTestObject('AT_Buat Berita/Deskripsi'), Deskripsi)

WebUI.setText(findTestObject('AT_Buat Berita/input__svelte-17qb5ew'), Provinsi)

WebUI.sendKeys(findTestObject('AT_Buat Berita/input__svelte-17qb5ew'), Keys.chord(Keys.DOWN))

WebUI.sendKeys(findTestObject('AT_Buat Berita/input__svelte-17qb5ew'), Keys.chord(Keys.ENTER))
